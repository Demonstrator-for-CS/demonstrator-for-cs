...
export default function XorGate() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full px-8">
            <h2 className="text-5xl font-bold mb-8 text-orange-600">XOR Gate</h2>
                ...
                <div className="flex gap-12 items-center justify-center">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="grid grid-cols-3 gap-3 text-center font-mono text-lg">
                            ...
                            <div className={`p-4 rounded ${!inputA && !inputB ? 'bg-orange-200 ring-2 ring-orange-500' : 'bg-red-100'}`}>0</div>
                            <div className={`p-4 rounded ${!inputA && !inputB ? 'bg-orange-200 ring-2 ring-orange-500' : 'bg-red-100'}`}>0</div>
                            <div className={`p-4 rounded ${!inputA && !inputB ? 'bg-orange-200 ring-2 ring-orange-500' : 'bg-red-100'}`}>0</div>

                            <div className={`p-4 rounded ${!inputA && inputB ? 'bg-orange-200 ring-2 ring-orange-500' : 'bg-red-100'}`}>0</div>
                            <div className={`p-4 rounded ${!inputA && inputB ? 'bg-orange-200 ring-2 ring-orange-500' : 'bg-green-100'}`}>1</div>
                            <div className={`p-4 rounded ${!inputA && inputB ? 'bg-orange-200 ring-2 ring-orange-500' : 'bg-green-100'}`}>1</div>
