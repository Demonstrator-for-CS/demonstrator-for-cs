...
export default function Intro() {
    return (
        <div className="flex flex-col items-center justify-center h-full text-center px-8 gap-6">
            <p className="text-2xl text-gray-700 max-w-2xl animate-fade-in">
            ...
            <p className="text-2xl text-gray-700 max-w-2xl animate-fade-in opacity-0" style={{ animationDelay: '3.0s', animationFillMode: 'forwards' }}>
