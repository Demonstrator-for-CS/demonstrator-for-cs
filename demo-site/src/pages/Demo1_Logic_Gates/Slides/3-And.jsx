...
export default function AndGate() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-8">
      <h2 className="text-5xl font-extrabold mb-8 text-indigo-700 drop-shadow-sm">AND Gate</h2>
      ...
      <div className="bg-white p-10 rounded-3xl shadow-2xl shadow-indigo-200/60 border border-indigo-100 max-w-6xl w-full animate-fade-in opacity-0" style={{ animationDelay: "0.5s", animationFillMode: "forwards" }}>
        <p className="text-2xl mb-10 text-slate-900 font-semibold text-center">
          The AND gate outputs TRUE only when <span className="font-bold text-indigo-600">both inputs are TRUE</span>.
        </p>
        ...
        <div className="flex gap-12 items-center justify-center">
          <div className="flex-1 flex items-center justify-center gap-6">
            ...
            <div className="flex flex-col items-center">
              <div className="text-3xl font-extrabold text-indigo-600 mb-3 drop-shadow-sm">AND</div>
