...
export default function AndGate() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full px-8">
            <h2 className="text-5xl font-bold mb-8 text-blue-600">AND Gate</h2>
                ...
                <div className="flex gap-12 items-center justify-center">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="grid grid-cols-3 gap-3 text-center font-mono text-lg">
                            ...
                            <div className={`p-4 rounded ${!inputA && !inputB ? 'bg-blue-200 ring-2 ring-blue-500' : 'bg-red-100'}`}>0</div>
                            <div className={`p-4 rounded ${!inputA && !inputB ? 'bg-blue-200 ring-2 ring-blue-500' : 'bg-red-100'}`}>0</div>
                            <div className={`p-4 rounded ${!inputA && !inputB ? 'bg-blue-200 ring-2 ring-blue-500' : 'bg-red-100'}`}>0</div>

                            <div className={`p-4 rounded ${!inputA && inputB ? 'bg-blue-200 ring-2 ring-blue-500' : 'bg-red-100'}`}>0</div>
                            <div className={`p-4 rounded ${!inputA && inputB ? 'bg-blue-200 ring-2 ring-blue-500' : 'bg-green-100'}`}>1</div>
                            <div className={`p-4 rounded ${!inputA && inputB ? 'bg-blue-200 ring-2 ring-blue-500' : 'bg-red-100'}`}>0</div>
