...
export default function CombiningGates() {
    return (
        <div className="flex flex-col items-center justify-center h-full px-8 gap-12">
            ...
            <p className="text-xl text-gray-600 text-center max-w-3xl animate-fade-in opacity-0" style={{ animationDelay: '1.5s', animationFillMode: 'forwards' }}>
                By connecting outputs of one gate to inputs of another, we can build circuits that perform sophisticated operations.
            </p>

            <p className="text-xl text-gray-600 text-center max-w-3xl animate-fade-in opacity-0" style={{ animationDelay: '3.0s', animationFillMode: 'forwards' }}>
